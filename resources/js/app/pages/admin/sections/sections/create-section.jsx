...
import { get_sections_thunk, store_sections_thunk } from '../redux/sections-thunk';
...
export default function CreateSection() {
    ...
    async function submitForm(params) {
        setLoading(true)
        const result = await store.dispatch(store_sections_thunk(data))
    ...
    return (
        <div>
            ...
            <Button variant='contained' onClick={toggleDrawer(true)}>Create sections</Button>
            <Drawer
