...
import { setSearch } from '@/app/pages/admin/instructor/redux/instructor-slice';
import { search_students_thunk } from '@/app/pages/admin/instructor/redux/instructor-thunk';

export default function IntructorIDSearchStudentsSection() {
  ...
  const subject_code = window.location.pathname.split('/')[3]
